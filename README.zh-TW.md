...
前往 [Releases](https://github.com/slzn/ScreenOnAuto-releases/releases) 頁面，下載最新版 `ScreenOnAuto-V1.4.0.apk`。
...
1. 從 [Releases](https://github.com/slzn/ScreenOnAuto-releases/releases) 頁面下載 `ScreenOnAuto-V1.4.0.apk`
