...
Installez ScreenOnAuto via la liste de testeurs bêta de Google Play — **obligatoire sur Android 14 et plus**.

> **ℹ️ Remarque**
> Vous installez ainsi l'**app ScreenOnAuto complète et officielle**. La liste de
> testeurs bêta de Google n'est que son mode de distribution (et ce qui lui permet
...
1. Ouvrez le formulaire d'**inscription**, connectez-vous si nécessaire, cochez la case
   ...
   🟢 **Rejoindre le test :** https://docs.google.com/forms/d/1tc18YdGins12x4tgGYuQkr0yXiwLCbbNkhf8swmYlM8/viewform
...
4. **Après l'installation**, ouvrez **Android Auto → Personnaliser le lanceur** et vérifiez que les **trois** entrées ScreenOnAuto apparaissent (plein écran, Legacy et Media Controller). Voir [Vérifier dans Android Auto](/fr/#verify) pour la liste complète et quoi faire s'il en manque une.
...
🔴 **Quitter le test :** https://docs.google.com/forms/d/1GwlycvaZv2AfvPGCz5gVpiv7ZpwJJrrK-5QujHz2ySc/viewform
...
- Une version installée via Play et un APK en sideload utilisent des **certificats de
  signature différents** : ils ne peuvent pas se mettre à jour l'un l'autre sur le même
  appareil. Pour changer de canal, désinstallez d'abord la version existante.
